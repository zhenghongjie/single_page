<template>
	<div class="company">
		...
		<div id="warhouse-list" v-show="list_more" @click="hide_list" :class="{'list_fixed':fixed_top}">
			<div class="blank"></div>
			<ul class="j-warelist">
		...
		created: function() {
			...
			window.addEventListener('scroll', function() {
				...
				if(top > 150) {
					  ...
					  _this.list_more==true ?  _this.fixed_top=true :  _this.fixed_top=false;
